    ...
    return (
      <section className="Container">
        {this.props.teams.length === 0 && (
          <p id="welcome-text">
            Welcome to Pinnie Toss, an app designed for the casual football fan.
            Whether you're looking for a team to support for now, for later, or
            for always, Pinnie Toss is here to find you a team to love.
          </p>
        )}
        <article className="buttonContainer">
          <Switch>
            ...
            <Route path="/team" render={() => <RandomPick />} />
