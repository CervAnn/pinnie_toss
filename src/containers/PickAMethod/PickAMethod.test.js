...
import { PickAMethod, mapStateToProps, mapDispatchToProps } from './PickAMethod';
...
describe('PickAMethod', () => {
  ...
  describe('mapDispatchToProps', () => {
    it('should dispatch pickRandom when called', () => {
      ...
      mappedProps.pickRandom([{idTeam: "134920", strTeam: "New England Patriots"}, {idTeam: "134922", strTeam: "Baltimore Ravens"}]);
