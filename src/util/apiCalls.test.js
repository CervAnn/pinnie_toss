...
describe('fetchFootballData', () => {
  ...
  it('should call fetch with the correct Url', () => {
    ...
    expect(window.fetch).toHaveBeenCalledWith('https://www.thesportsdb.com/api/v1/json/1/search_all_teams.php?s=American_Football&c=USA')
  });
  ...
  it('should return an error (SAD) :(', () => {
    ...
    expect(fetchFootballData()).rejects.toEqual(Error('There was an issue grabbing the data.'));
  });
  ...
  it('should return an error if the promise rejects (SAD) :(', () => {
    ...
    expect(fetchFootballData()).rejects.toEqual({ message: 'There was an issue grabbing the data.' })
  });
});